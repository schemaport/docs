...
```console
$ schemaport check tools
✗ tools/v2/refund-order.json: Duplicate tool name `refund_order`, already defined in /private/tmp/sp-dup/tools/v1/refund-order.json.
✗ tools/v2/search-orders.json: Duplicate tool name `search_orders`, already defined in /private/tmp/sp-dup/tools/v1/search-orders.json.
✗ tools/v2/refund-order.json: Duplicate tool name `refund_order`, already defined in /private/tmp/sp-dup/tools/v1/refund-order.json.
✗ tools/v2/search-orders.json: Duplicate tool name `search_orders`, already defined in /private/tmp/sp-dup/tools/v1/search-orders.json.
