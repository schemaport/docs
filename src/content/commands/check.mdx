...
|---|---|---|
| `--targets <ids>` | all four | Comma-separated list of `openai`, `anthropic`, `gemini`, `mcp`, or the shorthand `all`. Results are printed in the order you list them. An unknown id exits `2` and lists the valid ids. |
