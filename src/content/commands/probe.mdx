...
It is the only command that needs credentials and makes a network request. The `schemaport probe` command compiles each tool, sends the definition to the provider API, and reports one of four verdicts: accepted, rejected, error, or skipped.
<!-- thally-cite:v1:c7f8ba32862e82f608f2f46722ef9dc948b92052f58203cdb301aa0e96e5d9f6 -->
<!-- thally-cite:v1:7d910da65143e21bf9e6b752bbe3267d051a56f33a6b40643dfcfc9f6ebcd727 -->
network request.
