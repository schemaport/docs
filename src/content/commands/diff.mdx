...
The `summarizeDiff` function is used to summarize the changes. The `summarizeChanges` function is deprecated and has been renamed to `summarizeDiff`. It is still available for backwards compatibility, but it is recommended to use `summarizeDiff` in new code.
<!-- thally-cite:v1:4caf768dd18fe9a96b3c934531bd50d86e1c3f1c593f875c9f211c5d113c35c9 -->
