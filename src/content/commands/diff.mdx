...
Anything the diff engine cannot confidently classify is reported as breaking, because a false 'safe' is the expensive mistake. The full classification is on [Breaking changes](/concepts/breaking-changes). Additionally, making a property required is considered a breaking change, as existing callers may not provide the required value.
<!-- thally-cite:v1:285914735ca7cb075458347b148390ec51166d974ebd19585cb95f75779cef5e -->
<!-- thally-cite:v1:047a6948b6c2591cdabf1e28c18fd80f3f31302b605496ddb4e8f6acf1085739 -->
